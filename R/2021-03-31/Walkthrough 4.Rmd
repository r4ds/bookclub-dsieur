...
dirs <- glue("{here('Desktop', 'data', 'longitudinal_data')}/{filenames}")

walk2(urls, dirs, ~ download.file(url = urls, destfile = dirs, mode = "w"))
```
]
]
...
```{r, message = FALSE}
# filter to top 6 states and create a new object
high_count <-
  child_counts %>%
